...
export const solutionIcons = {
  ...
  "telecaller-telesales-services": Phone,
...
export const solutionStageIcons = {
  ...
  "telecaller-telesales-services": [ClipboardList, GraduationCap, Phone, ChartNoAxesCombined],
...
const activityIcons: Record<string, LucideIcon> = {
  ...
  "Telecalling": Phone,
  "Telesales": Headset,
  "Telecalling / outbound calling": Phone,
  "Lead follow-up & conversion": ChartNoAxesCombined,
  "Customer calling & support": MessageCircle,
  "Sales calling": Headset,
  "Appointment / demo booking": CalendarDays,
  "Verification & feedback calling": ClipboardCheck,
  "Inbound & outbound call handling": Phone,
  "Dedicated telecaller / telesales manpower": UsersRound,
