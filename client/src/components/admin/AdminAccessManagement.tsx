    ...
    <div className="zba-access-page">
      ...
      <section className="zba-directory">
        <header className="zba-directory-head">
          ...
          <span className="zba-directory-security"><ShieldCheck aria-hidden="true" /> MFA required in production</span>
        </header>
