...
export function AdminAiAssistant() {
  ...
  function openEdit(item: AiKnowledgeDocument) {
    ...
    setForm({
      ...
      reviewDueAt: item.reviewDueAt?.slice(0, 10) ?? "",
  ...
  async function saveKnowledge(event: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...form, keywords: splitTags(keywordText), aliases: splitTags(aliasText),
      description: form.description?.trim() || undefined,
      validFrom: form.validFrom || null, validUntil: form.validUntil || null, reviewDueAt: form.reviewDueAt || null,
      ownerDepartment: form.ownerDepartment?.trim() || null, supersedesDocumentId: form.supersedesDocumentId?.trim() || null,
      sourceVersion: form.sourceVersion?.trim() || "1",
    };
    try {
