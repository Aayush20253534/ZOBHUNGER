    ...
    <div className="zto-detail-layout">
      <main className="zto-match-panel">
        ...
        {tab === "matches" ? <>
          ...
          {matches?.candidatePoolTruncated && <div className="zto-alert" role="status"><CircleAlert aria-hidden="true" />Matching scanned the first {matches.scannedCandidates.toLocaleString("en-IN")} eligible candidates allowed by the safety cap. Narrow the institute or search filters for a complete result set.</div>}
