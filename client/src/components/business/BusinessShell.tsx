...
import { ArrowUpRight, Building2, CircleHelp, House, LogOut, Menu, ShieldCheck, UserRound } from "lucide-react";
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle, SheetTrigger } from "@/components/ui/sheet";
import { useBusiness } from "./BusinessProvider";
import { BusinessWordmark } from "./BusinessUI";

const links = [{ href: "/business", label: "Overview", icon: House }, { href: "/business/company", label: "Company profile", icon: Building2 }, { href: "/business/account", label: "Account & security", icon: UserRound }];
  ...
  return <div className="zb-biz-shell">
    ...
    <div className="zb-biz-workarea">
      <header className="zb-biz-topbar">
        ...
        <span className="zb-biz-topbar-title">{pathname === "/business/onboarding" ? "Company setup" : links.find(link => link.href === pathname)?.label ?? "Business workspace"}</span>
