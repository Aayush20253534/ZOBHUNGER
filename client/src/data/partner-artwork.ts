...
export const partnerArtwork: Partial<Record<string, PartnerArtwork>> = {
  ...
  Delhivery: { file: "delhivery.png", fit: "wordmark", scale: 3.85, miniScale: 3.0 },
  Shadowfax: { file: "shadowfax.webp", fit: "wordmark", scale: 2.72, miniScale: 2.12 },
  ...
  InDrive: { file: "indrive.png", fit: "wordmark", scale: 2.95, miniScale: 2.2 },
  ...
  Instamart: { file: "Instamart.jfif", fit: "wordmark", scale: 2.55, miniScale: 2.05 },
  "Park+": { file: "park.jpeg", fit: "badge", scale: 1.35, miniScale: 1.22 },
  Freecharge: { file: "freecharge.png", fit: "wordmark", scale: 1.62, miniScale: 1.38 },
  MobiKwik: { file: "mobikwik.png", fit: "wordmark", scale: 3.45, miniScale: 2.45 },
  ...
  "Amazon QR": { file: "Amazon-qr.png", fit: "wordmark", scale: 1.22, miniScale: 1.16 },
  Airtel: { file: "airtel.png", fit: "badge", scale: 1.22, miniScale: 1.16 },
  "Pine Labs": { file: "pine-labs.jpeg", fit: "wordmark", scale: 1.1, miniScale: 1.05 },
  Tide: { file: "tide.png" },
  Cheq: { file: "cheq.png", fit: "wordmark", scale: 3.15, miniScale: 2.55 },
  PagarBook: { file: "pagarbook.webp", fit: "badge", scale: 2.28, miniScale: 1.78 },
  BharatPe: { file: "Bharatpe.png", fit: "wordmark", scale: 3.12, miniScale: 2.32 },
  ...
  "Airtel Payments Bank": { file: "airtel_payments_bank.png", fit: "wordmark", scale: 3.15, miniScale: 2.25 },
  "Axis Bank": { file: "axis-bank.svg" },
  "YES BANK": { file: "yesbank.jpg", fit: "wordmark", scale: 1.42, miniScale: 1.26 },
  "Kotak 811": { file: "kotak-811.png" },
  PwC: { file: "pwc.png", fit: "balanced", scale: 1.78, miniScale: 1.48 },
  "WhiteHat Jr.": { file: "whitehat jr.png", fit: "wordmark", scale: 3.45, miniScale: 2.48 },
  ...
  Usha: { file: "usha.png", fit: "wordmark", scale: 3.25, miniScale: 2.6 },
