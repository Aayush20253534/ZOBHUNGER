...
export const partnerArtwork: Partial<Record<string, PartnerArtwork>> = {
  ...
  MobiKwik: { file: "mobikwik.png", fit: "wordmark", scale: 2.4, miniScale: 1.88 },
  ...
  Tide: { file: "tide.png" },
  Cheq: { file: "cheq.png" },
  PagarBook: { file: "pagarbook.webp", fit: "badge", scale: 1.58, miniScale: 1.36 },
  BharatPe: { file: "Bharatpe.png", fit: "wordmark", scale: 2.08, miniScale: 1.72 },
  ...
  PwC: { file: "pwc.png", fit: "balanced", scale: 1.42, miniScale: 1.28 },
  "WhiteHat Jr.": { file: "whitehat jr.png", fit: "wordmark", scale: 2.12, miniScale: 1.76 },
  Subway: { file: "subway-logo-png_seeklogo-287348.png", fit: "wordmark", scale: 1.68, miniScale: 1.44 },
  ...
  Marlboro: { file: "marlboro.jpeg", fit: "badge", scale: 1.48, miniScale: 1.3 },
  "Brown-Forman": { file: "brown-forman logo.png", fit: "balanced", scale: 1.82, miniScale: 1.5 },
  "Jim Beam": { file: "Jim-Beam.png", fit: "wordmark", scale: 1.72, miniScale: 1.46 },
  "Tilaknagar Industries": { file: "tilaknagar.svg", fit: "balanced", scale: 1.48, miniScale: 1.3 },
