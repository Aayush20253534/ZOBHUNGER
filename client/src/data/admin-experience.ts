...
export const adminDepartmentExperience: Record<AdminDepartment, AdminDepartmentExperience> = {
  ...
  PF_EPFO: {
    ...
    headline: "Keep provident-fund records complete and reviewable.",
    description: "Review employee PF / EPFO submissions, resolve corrections and export the approved statutory data from one controlled desk.",
    queueTitle: "PF / EPFO review queue",
    queueDescription: "Submitted or corrected PF records that may need a compliance decision.",
    emptyQueueTitle: "No PF / EPFO reviews are waiting",
    emptyQueueDescription: "Submitted employee PF records will appear here as soon as they require department action.",
  },
  ESIC: {
    label: "ESIC",
    shortLabel: "ESIC",
    eyebrow: "Statutory compliance",
    headline: "Keep employee ESI records and family details accountable.",
    description: "Review ESIC applicability, nominee and family details, request corrections and prepare clean department exports without exposing unrelated admin data.",
    queueTitle: "ESIC review queue",
    queueDescription: "Submitted or corrected ESIC records that may need a compliance decision.",
    emptyQueueTitle: "No ESIC reviews are waiting",
    emptyQueueDescription: "Submitted employee ESIC records will appear here as soon as they require department action.",
  },
  ACCOUNTS: {
    label: "Accounts",
    shortLabel: "Accounts",
    eyebrow: "Finance operations",
    headline: "Keep finance reporting scoped and traceable.",
    description: "Use only the finance and reporting areas assigned to this account while the wider employee and compliance records remain permission-bound.",
    queueTitle: "Accounts review queue",
    queueDescription: "Assigned finance records will appear here when a connected workflow needs attention.",
    emptyQueueTitle: "No finance reviews are waiting",
    emptyQueueDescription: "Your accounts workspace is clear. Assigned finance work will appear when action is required.",
  },
  TECHNICAL: {
    label: "Technical",
...
export const adminPermissionLabels: Partial<Record<AdminPermission, string>> = {
  ...
  PF_VIEW: "PF / EPFO records",
  PF_VERIFY: "PF / EPFO verification",
  PF_UPDATE: "PF / EPFO updates",
  PF_EXPORT: "PF / EPFO exports",
  ESIC_VIEW: "ESIC records",
  ESIC_VERIFY: "ESIC verification",
  ESIC_UPDATE: "ESIC updates",
  ESIC_EXPORT: "ESIC exports",
