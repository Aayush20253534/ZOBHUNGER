...
import type { ApprovalDetail, ApprovalQueue, ApprovalRecord, DraftData, HiringBrief, JobInput, LinkedJob, LinkedJobs, OperationsSummary, Page, ReportData, ReportFilters, ReportType, RequirementDraft } from "@/types/phase2.types";
...
export const getHiringBriefs = (page: number, query: string, signal?: AbortSignal) => phaseGet<Page<HiringBrief>>(`/admin/requirement-jobs?${params({ page, query })}`, signal);
