...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [{ url: "/Logo/favicon.png", type: "image/png", sizes: "1254x1254" }],
    shortcut: [{ url: "/Logo/favicon.png", type: "image/png" }],
    apple: [{ url: "/Logo/favicon.png", type: "image/png", sizes: "1254x1254" }],
  },
