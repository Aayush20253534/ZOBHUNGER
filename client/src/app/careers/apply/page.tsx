...
export const metadata = getPageMetadata("Submit Your Career Profile", "Share your education, experience, skills and resume with ZOBHUNGER's HR team for recruitment review.", "/careers/apply");
export default function Page() {
  return <div className="zb-intake-page">
    ...
    <header className="zb-intake-heading"><span className="zb-eyebrow">Careers · Meet your next opportunity</span><h1>Your experience.<br />Your skills. Your next chapter.</h1><p>Tell us about yourself and the work you want to do. Our HR team will review your profile and contact you if you are shortlisted for a relevant opportunity.</p></header>
