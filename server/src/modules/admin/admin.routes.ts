...
import { adminChatbotRouter } from "../chatbot/admin/chatbot-admin.routes.js";
import { adminArticlesRouter } from "../articles/admin-articles.routes.js";
...
import { adminEsicComplianceRouter, adminPfComplianceRouter } from "../compliance/compliance.routes.js";
...
adminRouter.use("/ai-assistant", adminChatbotRouter);
