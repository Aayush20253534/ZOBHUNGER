...
placementCellsRouter.post("/portal/candidates", requireAuth, requireRole("PLACEMENT_CELL"), portalWrite, validate({ body: placementCandidateBodySchema }), createPlacementCandidateController);
placementCellsRouter.put("/portal/candidates/:id", requireAuth, requireRole("PLACEMENT_CELL"), portalWrite, validate({ params: placementCandidateParamsSchema, body: placementCandidateBodySchema }), updatePlacementCandidateController);
placementCellsRouter.delete("/portal/candidates/:id", requireAuth, requireRole("PLACEMENT_CELL"), portalWrite, validate({ params: placementCandidateParamsSchema }), deletePlacementCandidateController);
...
placementCellsRouter.post("/portal/opportunities/:jobId/applications", requireAuth, requireRole("PLACEMENT_CELL"), portalWrite, validate({ params: placementOpportunityParamsSchema, body: placementOpportunityApplicationSchema }), submitPlacementOpportunityApplicationController);
