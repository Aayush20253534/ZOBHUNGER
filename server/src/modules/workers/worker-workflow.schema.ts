...
export const workerApplicationsQuery = z.object({ page, query, status: z.enum(["ALL", ...applicationStages]).default("ALL"), source: z.enum(["ALL", "WORKER_PORTAL", "PUBLIC_FORM", "PLACEMENT_CELL"]).default("ALL"), jobId: id.optional(), requirementId: id.optional() }).strict();
