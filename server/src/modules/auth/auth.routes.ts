...
import { adminMfaConfirmController, adminMfaDisableController, adminMfaRotateController, adminMfaSetupController, changeAdminPasswordController, changeBusinessPasswordController, businessLoginController, loginController, logoutController, meController, placementCellLoginController, technicalInstituteLoginController, registerController } from "./auth.controller.js";
...
authRouter.post("/technical-institute-login", authRateLimiter, validate({ body: loginSchema }), technicalInstituteLoginController);
